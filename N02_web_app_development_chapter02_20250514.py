...
## pipenv run streamlit run .\N02_web_app_development_chapter02_20250514.py  ##

##Hello everybody! How are you doing? Let's write some text just to try this very simple summarization function. Let's check now it is doing...
...
def main():
    ...
    st.sidebar.image("nlp.jpg", width=200)##use_container_width=True)
    ...
    if choice == "Translation":
        ...
        if len(raw_text) < 3:
            ...
            target_lang = st.selectbox("Target Language", ["Chinese", "German", "Spanish", "French", "italian"])
